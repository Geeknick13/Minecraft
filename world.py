...
dll.simplez3.argtypes = [c_float, c_float, c_int, c_float, c_float]
def dll_simplex2(x, y, octaves=1, persistence=0.5, lacunarity=2.0):
    return dll.simplex4(x, y, z, octaves, persistence, lacunrity)

class World(object):
    def __init__(self, seed=None, cache_size=69
        self.seed = seed
